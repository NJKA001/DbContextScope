...
{
    /// <summary>
    /// Indicates whether or not a new IDbContextScope will join the ambient scope.
    /// </summary>
    public enum DbContextScopeOption
    {
        /// <summary>
        /// Join the ambient IDbContextScope if one exists. Creates a new
        /// one otherwise.
        /// 
        /// This is what you want in most cases. Joining the existing ambient scope
        /// ensures that all code within a business transaction uses the same IDbContext
        ...
        /// <summary>
        /// Ignore the ambient IDbContextScope (if any) and force the creation of 
        /// a new IDbContextScope. 
        /// 
        /// This is an advanced feature that should be used with great care. 
        /// 
        /// When forcing the creation of a new scope, new IDbContext instances will be 
        /// created within that inner scope instead of re-using the IDbContext instances that
